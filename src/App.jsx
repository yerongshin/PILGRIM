      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-box">
            ...
            <p className="mb-6">
             <b>➀ 출석은 매주 샘원들에게 직접 물어보기</b> <br />관상 X 지레짐작 X 입니다 !! <br />샘모임 시간 전에 출석 확인하는 시간을 루틴으로 가져가시는 것을 적극추천합니다 ㅎㅎ <br /><br />
              <b>➁ 유학생 및 군인 출석도 확인하기</b> <br /> 지체들이 온라인으로 필그림 집회를 드리는 경우도 많습니다 !! 누락되지 않도록 꼭 살펴주세요 :) <br /><br />
              <b>➂ 마지막 문항은 행정간사만 확인하므로, 자유롭게 남겨주세요!</b> 여러분이 남겨주신 말들 보는 재미가 쏠쏠합니다 😁 <br /><br />
              감사합니다 ❤️ 이번 텀 출석부 잘 부탁드려요 !! 
            </p>
            <button
